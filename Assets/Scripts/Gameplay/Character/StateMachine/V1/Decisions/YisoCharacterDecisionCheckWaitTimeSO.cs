...
namespace Gameplay.Character.StateMachine.Decisions {
    [CreateAssetMenu(fileName = "SO_FSM_Decision_Common_CheckWaitTime", menuName = "Yiso/State Machine/Decision/CheckWaitTime")]
    public class YisoCharacterDecisionCheckWaitTimeSO: YisoCharacterDecisionSO {
