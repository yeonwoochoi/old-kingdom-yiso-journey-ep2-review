...
namespace Core.Sound {
    ...
    /// </summary>
    public class YisoSoundManager : YisoMonoSingleton<YisoSoundManager>,
        ...
        public async void PlayBgm(YisoSoundId id) {
            ...
            try {
                ...
                YisoLogger.Error($"PlayBgm {id} failed: {e.Message}");
            }
        }
        ...
        public async void PlaySfx(YisoSoundId id) {
            try {
                ...
                YisoLogger.Error($"PlaySfx {id} failed: {e.Message}");
            }
        }
