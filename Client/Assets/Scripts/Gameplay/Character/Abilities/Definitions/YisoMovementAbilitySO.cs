...
namespace Gameplay.Character.Abilities.Definitions {
    [CreateAssetMenu(fileName = "SO_Ability_Movement", menuName = "Yiso/Abilities/Movement")]
    public class YisoMovementAbilitySO : YisoAbilitySO {
        // V1의 Settings 클래스 역할을 이 SO가 직접 합니다.
        [Header("Movement Settings")] [Tooltip("기본 이동 속도입니다. 실제 속도는 캐릭터의 스탯에 따라 달라질 수 있습니다.")]
